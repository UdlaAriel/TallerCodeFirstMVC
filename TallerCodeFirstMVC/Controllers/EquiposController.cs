...
namespace TallerCodeFirstMVC.Controllers
{
    public class EquiposController : Controller
    {
        ...
        public EquiposController(TallerCodeFirstMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,City,Titles,ForeignAccept,IdEstadio")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,City,Titles,ForeignAccept,IdEstadio")] Equipo equipo)
        {
            if (id != equipo.Id)
            {
                return NotFound();
