...
namespace TallerCodeFirstMVC.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(TallerCodeFirstMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Direction,City,Capacity")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Direction,City,Capacity")] Estadio estadio)
        {
            if (id != estadio.Id)
            {
                return NotFound();
